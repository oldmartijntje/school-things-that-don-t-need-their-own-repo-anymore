...
var RobotArm = function (canvas) {
    ...
    // Handles the blocks
    local.blocks = {};
    local.blocks.availableColors = ["red", "blue", "green", "white","orange","magenta","yellow","lime","gold","brown"];
    ...
    self.loadLevel = function(levelName) {
        switch (levelName) {
            ...
            case "exercise 11":
                ...
                self.setMap([
                    [],
                    [local.blocks.availableColors[Math.floor(Math.random() * local.blocks.availableColors.length)],local.blocks.availableColors[Math.floor(Math.random() * local.blocks.availableColors.length)],local.blocks.availableColors[Math.floor(Math.random() * local.blocks.availableColors.length)]],
                    [local.blocks.availableColors[Math.floor(Math.random() * local.blocks.availableColors.length)],local.blocks.availableColors[Math.floor(Math.random() * local.blocks.availableColors.length)],local.blocks.availableColors[Math.floor(Math.random() * local.blocks.availableColors.length)]],
                    [local.blocks.availableColors[Math.floor(Math.random() * local.blocks.availableColors.length)],local.blocks.availableColors[Math.floor(Math.random() * local.blocks.availableColors.length)],local.blocks.availableColors[Math.floor(Math.random() * local.blocks.availableColors.length)]],
                    [local.blocks.availableColors[Math.floor(Math.random() * local.blocks.availableColors.length)],local.blocks.availableColors[Math.floor(Math.random() * local.blocks.availableColors.length)],local.blocks.availableColors[Math.floor(Math.random() * local.blocks.availableColors.length)]],
                    [local.blocks.availableColors[Math.floor(Math.random() * local.blocks.availableColors.length)],local.blocks.availableColors[Math.floor(Math.random() * local.blocks.availableColors.length)],local.blocks.availableColors[Math.floor(Math.random() * local.blocks.availableColors.length)]],
